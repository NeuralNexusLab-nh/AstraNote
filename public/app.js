...
Object.assign(I18N.en, {
  ...
  aiPointThreeBody: "Only the note text and your instruction are processed for a request; PINs and encryption keys are never sent or stored.",
...
Object.assign(I18N["zh-Hant"], {
  ...
  aiPointThreeBody: "一次處理只使用筆記文字與你的指令；PIN 與加密金鑰絕不傳送或儲存。",
...
Object.assign(I18N.ja, {
  ...
  aiPointThreeBody: "処理に使うのはノート本文と指示だけです。PIN と暗号鍵は送信も保存もされません。",
