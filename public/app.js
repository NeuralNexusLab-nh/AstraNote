...
Object.assign(I18N.en, {
  ...
  encryptionTitle: "Compare four ways to protect a note.",
  encryptionIntro:
    "See what is encrypted, where encryption happens, and what stolen data would be needed to recover the original content.",
  ...
  encryptionClientColumn: "Browser-side",
  encryptionServerColumn: "Server can read",
  encryptionSharingColumn: "Sharing",
  encryptionExposureColumn: "Attacker still needs",
  ...
  encryptionAes256Security: "Stronger",
  encryptionSchybridExposure:
    "Encrypted note + account metadata + Vault secret + PIN, or an unlocked device",
  encryptionSchybridSecurity: "Layered",
  encryptionSchybridTitle: "How SCHybrid builds the encryption key",
  ...
  encryptionSchybridCaution:
    "AstraNote cannot recover a lost PIN. Use a unique 6-digit PIN and only trusted devices.",
...
Object.assign(I18N["zh-Hant"], {
  ...
  encryptionTitle: "比較四種筆記保護方式。",
  encryptionIntro:
    "快速比較內容是否加密、加密發生在哪裡，以及資料遭竊後還缺少什麼才能還原原文。",
  ...
  encryptionClientColumn: "瀏覽器端",
  encryptionServerColumn: "伺服器可讀",
  encryptionSharingColumn: "分享",
  encryptionExposureColumn: "駭客還需要",
  ...
  encryptionAes256Security: "更強",
  encryptionSchybridExposure:
    "加密筆記 + 帳號資料 + Vault 祕密 + PIN，或已解鎖裝置",
  encryptionSchybridSecurity: "分層",
  encryptionSchybridTitle: "SCHybrid 如何建立加密密鑰",
  ...
  encryptionSchybridCaution:
    "AstraNote 無法找回遺失的 PIN。請使用不重複的 6 位數 PIN，並只在信任的裝置輸入。",
...
I18N.ja = {
  ...
  encryptionTitle: "4 つのノート保護方法を比較。",
  encryptionIntro:
    "内容が暗号化されるか、どこで暗号化されるか、盗まれたデータから原文を戻すために何が必要かを比較できます。",
  ...
  encryptionClientColumn: "ブラウザ側",
  encryptionServerColumn: "サーバーで読める",
  encryptionSharingColumn: "共有",
  encryptionExposureColumn: "攻撃者にさらに必要",
  encryptionSecurityColumn: "安全性",
  encryptionYes: "はい",
  encryptionNo: "いいえ",
  ...
  encryptionAes256Security: "より強い",
  encryptionSchybridExposure:
    "暗号化ノート + アカウント情報 + Vault 秘密 + PIN、または解錠済み端末",
  encryptionSchybridSecurity: "多層",
  encryptionSchybridTitle: "SCHybrid が暗号鍵を作る流れ",
  ...
  encryptionSchybridCaution:
    "紛失した PIN は復元できません。固有の 6 桁 PIN を使い、信頼できる端末だけで入力してください。",
