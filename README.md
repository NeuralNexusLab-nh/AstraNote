...
strict per-account storage limits, and NexaCAPTCHA Gravity verification for
...
- 100-note and 256 KiB full-account-directory limits
...
- NexaCAPTCHA Gravity with mandatory server-side `/api/siteverify` validation
